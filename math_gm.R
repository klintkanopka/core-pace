...
spec_1 <- "math_sbac_std ~ lag(sela_gm_std, 1)"
...
spec_2 <- "math_sbac_std ~ lag(sela_gm_std, 1) + lag(sela_gm_std, 2) + lag(math_sbac_std, 2)"
...
spec_3 <- "math_sbac_std ~ lag(sela_gm_std, 1) + lag(sela_gm_std, 2) + lag(math_sbac_std, 1) + lag(math_sbac_std, 2)"
...
spec_4 <- "math_sbac_std ~ lag(sela_gm_std, 1) + lag(math_sbac_std, 1) + lag(math_sbac_std, 2) + as.factor(cds)"
