...
model_1_t2 <- plm(as.formula(spec_1), data = d, model="within")
#m1_t2_se <- coeftest(model_1_t2, 
#                     vcov=vcovHC(model_1_t2, type="HC2", cluster="group"))[, 2]
...
model_2_t2 <- plm(as.formula(spec_2), data = d, model="pooling")
#m2_t2_se <- coeftest(model_2_t2, 
#                     vcov=vcovHC(model_2_t2, type="HC2", cluster="group"))[, 2]
...
model_3_t2 <- plm(as.formula(spec_3), data = d, model="pooling")
#m3_t2_se <- coeftest(model_3_t2, 
#                     vcov=vcovHC(model_3_t2, type="HC2", cluster="group"))[, 2]
...
model_4_t2 <- plm(as.formula(spec_4), data = d, model="pooling")
#m4_t2_se <- coeftest(model_4_t2, 
#                     vcov=vcovHC(model_4_t2, type="HC2", cluster="group"))[, 2]