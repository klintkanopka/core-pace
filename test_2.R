...
m1_t2_se <- sqrt(diag(vcovHC(model_1_t2, type="HC0", cluster="group")))
...
m2_t2_se <- sqrt(diag(vcovHC(model_2_t2, type="HC0", cluster="group")))
...
m3_t2_se <- sqrt(diag(vcovHC(model_3_t2, type="HC2", cluster="group")))
...
m4_t2_se <- sqrt(diag(vcovHC(model_4_t2, type="HC2", cluster="group")))
