...
spec_1 <- "ela_sbac_std ~ lag(sela_sa_std, 1)"
...
spec_2 <- "ela_sbac_std ~ lag(sela_sa_std, 1) + lag(sela_sa_std, 2) + lag(ela_sbac_std, 2)"
...
spec_3 <- "ela_sbac_std ~ lag(sela_sa_std, 1) + lag(sela_sa_std, 2) + lag(ela_sbac_std, 1) + lag(ela_sbac_std, 2)"
...
spec_4 <- "ela_sbac_std ~ lag(sela_sa_std, 1) + lag(ela_sbac_std, 1) + lag(ela_sbac_std, 2) + as.factor(cds)"
